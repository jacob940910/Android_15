package com.example.first.a503_19.a1019urlcommunication;
...
public class ImageDownload extends AppCompatActivity {
    ...
    Handler downloadHandler = new Handler(){
        ...
        public void handleMessage(Message message) {
            //파일이 존재하는 경우
            if(message.obj != null){
                //안드로이드의 Data디렉토리 경로를 가져오기
                String path = Environment.getDataDirectory().getAbsolutePath();
                //현재 앱 내의 파일경로 만들기
                path = path + "/data/com.example.first.a503_19.a1019urlcommunication/" +(String)message.obj;
    ...
    class DisplayThread extends Thread{
        ...
        public void run() {
            try{
                String addr = "http://www.newsworks.co.kr/news/photo/201810/303586_203533_1533.jpg";
                URL url = new URL(addr);
                //url에 연결해서 비트맵 만들기
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //이미지를 다운로드 받을 주소
                String imageUrl = "http://www.newsworks.co.kr/news/photo/201810/303586_203533_1533.jpg";
                //파일명 만들기
                int idx = imageUrl.lastIndexOf("/");
                String filename = imageUrl.substring(idx + 1);
                //파일 경로 만들기
                String data = Environment.getDataDirectory().getAbsolutePath();
                String path = data + "/data/com.example.first.a503_19.a1019urlcommunication/files/" + filename;
                //파일 존재여부를 확인
