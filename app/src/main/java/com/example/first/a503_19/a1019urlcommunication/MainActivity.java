    ...
    class ThreadEx extends Thread{
        ...
        public void run() {
            try {
                ...
                Log.e("디운로드 받을 주소",addr);
                //문자열 주소로 URL 객체 생성
                URL downloadUrl = new URL(addr);
                //연결된 객체 생성
                HttpsURLConnection con = (HttpsURLConnection)downloadUrl.openConnection();
                //옵션 설정
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //이구문이 출력이 안되면 버튼의 아이디를 확인
                //Log.e("버튼 클릭","클릭이벤트를 수행합니다.");
                progressDialog = ProgressDialog.show(MainActivity.this,"","다운로드중....");
